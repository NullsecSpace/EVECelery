...
from EVECelery.tasks.ESI.Alliance.get_alliances_alliance_id_icons import Success200_get_alliances_alliance_id_icons
...
class Test_get_alliances_alliance_id_icons:
    ...
    def test_get_sync(self, mock_env_celery):
        ...
        assert isinstance(r, Success200_get_alliances_alliance_id_icons)
