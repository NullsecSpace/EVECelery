...
from .Models.get_incursions_200 import Response200_get_incursions


class get_incursions(TaskESI):
    """
    List incursions
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_incursions]:
        """
        List incursions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_incursions`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_incursions`.
        """
