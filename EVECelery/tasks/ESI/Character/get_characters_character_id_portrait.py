...
from .Models.get_characters_character_id_portrait_200 import (
    Response200_get_characters_character_id_portrait,
)
...
class get_characters_character_id_portrait(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_portrait]:
        """
        Get character portraits
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_portrait`.
        """
    ...
    def run(self, character_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_portrait`.
        """
