...
class SuccessHeaders200_get_characters_character_id_portrait(ModelTaskBaseResponse):
    """
...
class Success200_get_characters_character_id_portrait(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_characters_character_id_portrait = Field(
        ..., description='The response headers for this request.'
    )
    px128x128: str | None = Field(description="px128x128 string")
    px256x256: str | None = Field(description="px256x256 string")
    px512x512: str | None = Field(description="px512x512 string")
    px64x64: str | None = Field(description="px64x64 string")


class get_characters_character_id_portrait(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/portrait/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_characters_character_id_portrait]:
        """
        Get character portraits
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_characters_character_id_portrait`.
        """
    ...
    def run(self, character_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_characters_character_id_portrait`.
        """
