...
class GetCharactersCharacterIdRolesOk(BaseModel):
    roles: Optional[
        List[
            Literal[
                'Account_Take_1',
...
class Headers200_get_characters_character_id_roles(ModelBaseEVECelery):
    """
...
class Response200_get_characters_character_id_roles(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_characters_character_id_roles = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCharactersCharacterIdRolesOk = Field(
