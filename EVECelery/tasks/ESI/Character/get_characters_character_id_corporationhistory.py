...
from .Models.get_characters_character_id_corporationhistory_200 import (
    Response200_get_characters_character_id_corporationhistory,
)


class get_characters_character_id_corporationhistory(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/corporationhistory/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_corporationhistory]:
        """
        Get corporation history
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_corporationhistory`.
        """
    ...
    def run(self, character_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_corporationhistory`.
        """
