...
from .Models.get_characters_character_id_blueprints_200 import (
    Response200_get_characters_character_id_blueprints,
)


class get_characters_character_id_blueprints(TaskESI):
    """
    Get blueprints
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/blueprints/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_blueprints]:
        """
        Get blueprints
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_blueprints`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_blueprints`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
