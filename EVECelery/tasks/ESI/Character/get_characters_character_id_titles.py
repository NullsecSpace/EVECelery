...
from .Models.get_characters_character_id_titles_200 import (
    Response200_get_characters_character_id_titles,
)


class get_characters_character_id_titles(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/titles/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_titles]:
        """
        Get character corporation titles
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_titles`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_titles`.
        """
        return super().run(
