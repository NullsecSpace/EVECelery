...
from .Models.get_characters_character_id_notifications_contacts_200 import (
    Response200_get_characters_character_id_notifications_contacts,
)


class get_characters_character_id_notifications_contacts(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/notifications/contacts/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_notifications_contacts]:
        """
        Get new contact notifications
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_notifications_contacts`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_notifications_contacts`.
        """
        return super().run(
