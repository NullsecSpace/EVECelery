...
from .Models.post_characters_affiliation_200 import (
    Response200_post_characters_affiliation,
)


class post_characters_affiliation(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/characters/affiliation/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_post_characters_affiliation]:
        """
        Character affiliation
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_post_characters_affiliation`.
        """
    ...
    @validate_arguments
    def run(
        self, characters: list[int], datasource: str = "tranquility", **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_post_characters_affiliation`.
        """
        return super().run(characters=characters, datasource=datasource, **kwargs)
