...
from .Models.post_characters_character_id_cspa_201 import (
    Response201_post_characters_character_id_cspa,
)


class post_characters_character_id_cspa(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/cspa/"
    ...
    def get_sync(
    ...
    ) -> Union[Response201_post_characters_character_id_cspa]:
        """
        Calculate a CSPA charge cost
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response201_post_characters_character_id_cspa`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response201_post_characters_character_id_cspa`.
        """
        return super().run(
            character_id=character_id,
            characters=characters,
