...
from .Models.get_characters_character_id_agents_research_200 import (
    Response200_get_characters_character_id_agents_research,
)


class get_characters_character_id_agents_research(TaskESI):
    """
    Get agents research
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/agents_research/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_agents_research]:
        """
        Get agents research
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_agents_research`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_agents_research`.
        """
        return super().run(
