...
from .Models.get_characters_character_id_medals_200 import (
    Response200_get_characters_character_id_medals,
)


class get_characters_character_id_medals(TaskESI):
    """
    Get medals
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/medals/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_medals]:
        """
        Get medals
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_medals`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_medals`.
        """
        return super().run(
