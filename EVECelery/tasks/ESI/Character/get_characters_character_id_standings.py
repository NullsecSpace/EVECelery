...
from .Models.get_characters_character_id_standings_200 import (
    Response200_get_characters_character_id_standings,
)


class get_characters_character_id_standings(TaskESI):
    """
    Get standings
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/standings/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_standings]:
        """
        Get standings
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_standings`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_standings`.
        """
        return super().run(
