...
from .Models.get_alliances_alliance_id_corporations_200 import (
    Response200_get_alliances_alliance_id_corporations,
)
...
class get_alliances_alliance_id_corporations(TaskESI):
    ...
    def route(self, alliance_id: int, **kwargs) -> str:
        ...
        """
        return f"/alliances/{alliance_id}/corporations/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_alliances_alliance_id_corporations]:
        """
        List alliance's corporations
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_alliances_alliance_id_corporations`.
        """
    ...
    def run(self, alliance_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_alliances_alliance_id_corporations`.
        """
