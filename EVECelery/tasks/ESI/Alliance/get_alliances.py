...
from .Models.get_alliances_200 import Response200_get_alliances
...
class get_alliances(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_alliances]:
        """
        List all alliances
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_alliances`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_alliances`.
        """
