...
from .Models.get_characters_character_id_opportunities_200 import (
    Response200_get_characters_character_id_opportunities,
)


class get_characters_character_id_opportunities(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/opportunities/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_opportunities]:
        """
        Get a character's completed tasks
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_opportunities`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_opportunities`.
        """
        return super().run(
