...
class SuccessHeaders200_get_opportunities_tasks(ModelTaskBaseResponse):
    """
...
class Success200_get_opportunities_tasks(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_opportunities_tasks = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of opportunities task ids")


class get_opportunities_tasks(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_opportunities_tasks]:
        """
        Get opportunities tasks
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_opportunities_tasks`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_opportunities_tasks`.
        """
