...
from .Models.get_opportunities_tasks_200 import Response200_get_opportunities_tasks
...
class get_opportunities_tasks(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_opportunities_tasks]:
        """
        Get opportunities tasks
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_opportunities_tasks`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_opportunities_tasks`.
        """
