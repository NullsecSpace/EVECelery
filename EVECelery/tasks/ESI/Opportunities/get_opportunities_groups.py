...
from .Models.get_opportunities_groups_200 import Response200_get_opportunities_groups
...
class get_opportunities_groups(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_opportunities_groups]:
        """
        Get opportunities groups
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_opportunities_groups`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_opportunities_groups`.
        """
