...
class SuccessHeaders200_get_opportunities_groups(ModelTaskBaseResponse):
    """
...
class Success200_get_opportunities_groups(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_opportunities_groups = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of opportunities group ids")


class get_opportunities_groups(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_opportunities_groups]:
        """
        Get opportunities groups
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_opportunities_groups`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_opportunities_groups`.
        """
