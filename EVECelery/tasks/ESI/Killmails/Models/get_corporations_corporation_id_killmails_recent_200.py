...
class GetCorporationsCorporationIdKillmailsRecentOkItem(BaseModel):
...
class GetCorporationsCorporationIdKillmailsRecentOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdKillmailsRecentOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_killmails_recent(ModelBaseEVECelery):
    """
...
class Response200_get_corporations_corporation_id_killmails_recent(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_corporations_corporation_id_killmails_recent = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCorporationsCorporationIdKillmailsRecentOk = Field(
