...
class GetCharactersCharacterIdKillmailsRecentOkItem(BaseModel):
...
class GetCharactersCharacterIdKillmailsRecentOk(BaseModel):
    __root__: List[GetCharactersCharacterIdKillmailsRecentOkItem] = Field(
        ...,
...
class Headers200_get_characters_character_id_killmails_recent(ModelBaseEVECelery):
    """
...
class Response200_get_characters_character_id_killmails_recent(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_characters_character_id_killmails_recent = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCharactersCharacterIdKillmailsRecentOk = Field(
