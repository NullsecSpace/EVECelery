...
from .Models.get_characters_character_id_killmails_recent_200 import (
    Response200_get_characters_character_id_killmails_recent,
)


class get_characters_character_id_killmails_recent(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/killmails/recent/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_killmails_recent]:
        """
        Get a character's recent kills and losses
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_killmails_recent`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_killmails_recent`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
