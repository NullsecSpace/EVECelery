...
from .Models.get_corporations_corporation_id_killmails_recent_200 import (
    Response200_get_corporations_corporation_id_killmails_recent,
)


class get_corporations_corporation_id_killmails_recent(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/killmails/recent/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_killmails_recent]:
        """
        Get a corporation's recent kills and losses
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_killmails_recent`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_killmails_recent`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
