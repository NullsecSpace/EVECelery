...
from .Models.get_killmails_killmail_id_killmail_hash_200 import (
    Response200_get_killmails_killmail_id_killmail_hash,
)


class get_killmails_killmail_id_killmail_hash(TaskESI):
    """
    ...
    def route(self, killmail_hash: str, killmail_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/killmails/{killmail_id}/{killmail_hash}/"
    ...
    def cache_ttl_default(self) -> int:
        ...
        """
        return 30758400  # current esi x-cached-seconds header
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_killmails_killmail_id_killmail_hash]:
        """
        Get a single killmail
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_killmails_killmail_id_killmail_hash`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_killmails_killmail_id_killmail_hash`.
        """
        return super().run(
            killmail_hash=killmail_hash,
            killmail_id=killmail_id,
