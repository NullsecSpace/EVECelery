...
from .Models.get_characters_character_id_search_200 import (
    Response200_get_characters_character_id_search,
)
...
class get_characters_character_id_search(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_search]:
        """
        Search on a string
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_search`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_search`.
        """
        return super().run(
            categories=categories,
            character_id=character_id,
