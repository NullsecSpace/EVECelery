...
from .Models.post_corporations_corporation_id_assets_locations_200 import (
    Response200_post_corporations_corporation_id_assets_locations,
)


class post_corporations_corporation_id_assets_locations(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/assets/locations/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_post_corporations_corporation_id_assets_locations]:
        """
        Get corporation asset locations
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_post_corporations_corporation_id_assets_locations`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_post_corporations_corporation_id_assets_locations`.
        """
        return super().run(
            corporation_id=corporation_id,
            item_ids=item_ids,
