...
from .Models.get_corporations_corporation_id_assets_200 import (
    Response200_get_corporations_corporation_id_assets,
)


class get_corporations_corporation_id_assets(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/assets/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_assets]:
        """
        Get corporation assets
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_assets`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_assets`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
