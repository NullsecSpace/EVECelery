...
class GetCorporationsCorporationIdAssetsOkItem(BaseModel):
...
class GetCorporationsCorporationIdAssetsOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdAssetsOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_assets(ModelBaseEVECelery):
    """
...
class Response200_get_corporations_corporation_id_assets(ModelCachedResponse):
    """
    A list of assets
    ...
    headers: Headers200_get_corporations_corporation_id_assets = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCorporationsCorporationIdAssetsOk = Field(
