...
from .Models.get_characters_character_id_assets_200 import (
    Response200_get_characters_character_id_assets,
)


class get_characters_character_id_assets(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/assets/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_assets]:
        """
        Get character assets
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_assets`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_assets`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
