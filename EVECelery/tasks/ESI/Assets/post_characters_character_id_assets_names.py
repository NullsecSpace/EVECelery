...
from .Models.post_characters_character_id_assets_names_200 import (
    Response200_post_characters_character_id_assets_names,
)


class post_characters_character_id_assets_names(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/assets/names/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_post_characters_character_id_assets_names]:
        """
        Get character asset names
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_post_characters_character_id_assets_names`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_post_characters_character_id_assets_names`.
        """
        return super().run(
            character_id=character_id,
            item_ids=item_ids,
