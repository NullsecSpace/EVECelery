...
from .Models.put_characters_character_id_contacts_204 import (
    Response204_put_characters_character_id_contacts,
)


class put_characters_character_id_contacts(TaskESI):
    """
    Edit contacts
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response204_put_characters_character_id_contacts]:
        """
        Edit contacts
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_put_characters_character_id_contacts`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_put_characters_character_id_contacts`.
        """
        return super().run(
            character_id=character_id,
            contact_ids=contact_ids,
