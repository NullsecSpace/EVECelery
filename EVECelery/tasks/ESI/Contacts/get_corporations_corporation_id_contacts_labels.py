...
from .Models.get_corporations_corporation_id_contacts_labels_200 import (
    Response200_get_corporations_corporation_id_contacts_labels,
)


class get_corporations_corporation_id_contacts_labels(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/contacts/labels/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_contacts_labels]:
        """
        Get corporation contact labels
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_contacts_labels`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_contacts_labels`.
        """
        return super().run(
