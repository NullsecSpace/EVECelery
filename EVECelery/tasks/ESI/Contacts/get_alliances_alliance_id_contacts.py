...
from .Models.get_alliances_alliance_id_contacts_200 import (
    Response200_get_alliances_alliance_id_contacts,
)


class get_alliances_alliance_id_contacts(TaskESI):
    """
    ...
    def route(self, alliance_id: int, **kwargs) -> str:
        ...
        """
        return f"/alliances/{alliance_id}/contacts/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_alliances_alliance_id_contacts]:
        """
        Get alliance contacts
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_alliances_alliance_id_contacts`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_alliances_alliance_id_contacts`.
        """
        return super().run(
            alliance_id=alliance_id,
            datasource=datasource,
