...
from .Models.get_characters_character_id_contacts_labels_200 import (
    Response200_get_characters_character_id_contacts_labels,
)


class get_characters_character_id_contacts_labels(TaskESI):
    """
    Get contact labels
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/contacts/labels/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_contacts_labels]:
        """
        Get contact labels
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_contacts_labels`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_contacts_labels`.
        """
        return super().run(
