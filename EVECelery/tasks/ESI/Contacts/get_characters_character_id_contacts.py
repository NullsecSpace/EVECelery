...
from .Models.get_characters_character_id_contacts_200 import (
    Response200_get_characters_character_id_contacts,
)


class get_characters_character_id_contacts(TaskESI):
    """
    Get contacts
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_contacts]:
        """
        Get contacts
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_contacts`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_contacts`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
