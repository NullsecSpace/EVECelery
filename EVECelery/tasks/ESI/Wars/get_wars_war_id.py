...
from .Models.get_wars_war_id_200 import Response200_get_wars_war_id


class get_wars_war_id(TaskESI):
    """
    Get war information
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_wars_war_id]:
        """
        Get war information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_wars_war_id`.
        """
    ...
    @validate_arguments
    def run(self, war_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_wars_war_id`.
        """
        return super().run(war_id=war_id, datasource=datasource, **kwargs)
