...
from .Models.get_wars_war_id_killmails_200 import Response200_get_wars_war_id_killmails


class get_wars_war_id_killmails(TaskESI):
    """
    ...
    def route(self, war_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/wars/{war_id}/killmails/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_wars_war_id_killmails]:
        """
        List kills for a war
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_wars_war_id_killmails`.
        """
    ...
    @validate_arguments
    def run(
        self, war_id: int, datasource: str = "tranquility", page: int = 1, **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_wars_war_id_killmails`.
        """
        return super().run(war_id=war_id, datasource=datasource, page=page, **kwargs)
