...
from .Models.get_wars_200 import Response200_get_wars
...
class get_wars(TaskESI):
    ...
    def get_sync(
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_wars`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_wars`.
        """
