...
class Headers204_post_ui_openwindow_information(ModelBaseEVECelery):
    """
...
class Response204_post_ui_openwindow_information(ModelCachedResponse):
    """
    ...
    headers: Headers204_post_ui_openwindow_information = Field(
