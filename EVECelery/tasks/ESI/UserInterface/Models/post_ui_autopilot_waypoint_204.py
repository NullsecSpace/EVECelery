...
class Headers204_post_ui_autopilot_waypoint(ModelBaseEVECelery):
    """
...
class Response204_post_ui_autopilot_waypoint(ModelCachedResponse):
    """
    ...
    headers: Headers204_post_ui_autopilot_waypoint = Field(
