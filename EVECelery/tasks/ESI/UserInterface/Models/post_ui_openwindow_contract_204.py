...
class Headers204_post_ui_openwindow_contract(ModelBaseEVECelery):
    """
...
class Response204_post_ui_openwindow_contract(ModelCachedResponse):
    """
    ...
    headers: Headers204_post_ui_openwindow_contract = Field(
