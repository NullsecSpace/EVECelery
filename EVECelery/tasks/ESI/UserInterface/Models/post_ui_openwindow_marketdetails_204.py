...
class Headers204_post_ui_openwindow_marketdetails(ModelBaseEVECelery):
    """
...
class Response204_post_ui_openwindow_marketdetails(ModelCachedResponse):
    """
    ...
    headers: Headers204_post_ui_openwindow_marketdetails = Field(
