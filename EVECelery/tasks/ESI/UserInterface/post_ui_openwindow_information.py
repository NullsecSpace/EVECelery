...
from .Models.post_ui_openwindow_information_204 import (
    Response204_post_ui_openwindow_information,
)


class post_ui_openwindow_information(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/ui/openwindow/information/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_post_ui_openwindow_information]:
        """
        Open Information Window
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_post_ui_openwindow_information`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_post_ui_openwindow_information`.
        """
        return super().run(
            target_id=target_id, datasource=datasource, token=token, **kwargs
        )
