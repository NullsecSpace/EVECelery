...
from .Models.post_ui_openwindow_marketdetails_204 import (
    Response204_post_ui_openwindow_marketdetails,
)


class post_ui_openwindow_marketdetails(TaskESI):
    """
    Open Market Details
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/ui/openwindow/marketdetails/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_post_ui_openwindow_marketdetails]:
        """
        Open Market Details
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_post_ui_openwindow_marketdetails`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_post_ui_openwindow_marketdetails`.
        """
        return super().run(
            type_id=type_id, datasource=datasource, token=token, **kwargs
        )
