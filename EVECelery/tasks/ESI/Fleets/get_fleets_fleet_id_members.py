...
from .Models.get_fleets_fleet_id_members_200 import (
    Response200_get_fleets_fleet_id_members,
)


class get_fleets_fleet_id_members(TaskESI):
    """
    Get fleet members
    """
    ...
    def route(self, fleet_id: int, **kwargs) -> str:
        ...
        """
        return f"/fleets/{fleet_id}/members/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fleets_fleet_id_members]:
        """
        Get fleet members
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fleets_fleet_id_members`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fleets_fleet_id_members`.
        """
        return super().run(
            fleet_id=fleet_id,
            datasource=datasource,
