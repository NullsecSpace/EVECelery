...
from .Models.delete_fleets_fleet_id_members_member_id_204 import (
    Response204_delete_fleets_fleet_id_members_member_id,
)


class delete_fleets_fleet_id_members_member_id(TaskESI):
    """
    Kick fleet member
    """
    ...
    def route(self, fleet_id: int, member_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/fleets/{fleet_id}/members/{member_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_delete_fleets_fleet_id_members_member_id]:
        """
        Kick fleet member
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_delete_fleets_fleet_id_members_member_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_delete_fleets_fleet_id_members_member_id`.
        """
        return super().run(
            fleet_id=fleet_id,
            member_id=member_id,
