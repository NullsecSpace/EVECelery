...
from .Models.delete_fleets_fleet_id_squads_squad_id_204 import (
    Response204_delete_fleets_fleet_id_squads_squad_id,
)


class delete_fleets_fleet_id_squads_squad_id(TaskESI):
    """
    Delete fleet squad
    """
    ...
    def route(self, fleet_id: int, squad_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/fleets/{fleet_id}/squads/{squad_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_delete_fleets_fleet_id_squads_squad_id]:
        """
        Delete fleet squad
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_delete_fleets_fleet_id_squads_squad_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_delete_fleets_fleet_id_squads_squad_id`.
        """
        return super().run(
            fleet_id=fleet_id,
            squad_id=squad_id,
