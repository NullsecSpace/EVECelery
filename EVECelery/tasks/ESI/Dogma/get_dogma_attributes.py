...
from .Models.get_dogma_attributes_200 import Response200_get_dogma_attributes
...
class get_dogma_attributes(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_dogma_attributes]:
        """
        Get attributes
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_dogma_attributes`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_dogma_attributes`.
        """
