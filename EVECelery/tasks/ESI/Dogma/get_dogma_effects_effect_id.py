...
from .Models.get_dogma_effects_effect_id_200 import (
    Response200_get_dogma_effects_effect_id,
)


class get_dogma_effects_effect_id(TaskESI):
    """
    ...
    def route(self, effect_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/dogma/effects/{effect_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_dogma_effects_effect_id]:
        """
        Get effect information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_dogma_effects_effect_id`.
        """
    ...
    @validate_arguments
    def run(self, effect_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_dogma_effects_effect_id`.
        """
        return super().run(effect_id=effect_id, datasource=datasource, **kwargs)
