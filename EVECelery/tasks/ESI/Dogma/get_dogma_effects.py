...
class SuccessHeaders200_get_dogma_effects(ModelTaskBaseResponse):
    """
...
class Success200_get_dogma_effects(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_dogma_effects = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of dogma effect ids")


class get_dogma_effects(TaskESI):
    """
    Get effects
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_dogma_effects]:
        """
        Get effects
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_dogma_effects`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_dogma_effects`.
        """
