...
from .Models.get_dogma_effects_200 import Response200_get_dogma_effects
...
class get_dogma_effects(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_dogma_effects]:
        """
        Get effects
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_dogma_effects`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_dogma_effects`.
        """
