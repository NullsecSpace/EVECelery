...
from .Models.get_dogma_dynamic_items_type_id_item_id_200 import (
    Response200_get_dogma_dynamic_items_type_id_item_id,
)


class get_dogma_dynamic_items_type_id_item_id(TaskESI):
    """
    ...
    def route(self, item_id: int, type_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/dogma/dynamic/items/{type_id}/{item_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_dogma_dynamic_items_type_id_item_id]:
        """
        Get dynamic item information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_dogma_dynamic_items_type_id_item_id`.
        """
    ...
    @validate_arguments
    def run(
        self, item_id: int, type_id: int, datasource: str = "tranquility", **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_dogma_dynamic_items_type_id_item_id`.
        """
        return super().run(
            item_id=item_id, type_id=type_id, datasource=datasource, **kwargs
        )
