...
class SuccessHeaders200_get_characters_character_id_online(ModelTaskBaseResponse):
    """
...
class Success200_get_characters_character_id_online(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_characters_character_id_online = Field(
        ..., description='The response headers for this request.'
    )
    last_login: str | None = Field(description="Timestamp of the last login")
    last_logout: str | None = Field(description="Timestamp of the last logout")
    logins: int | None = Field(
        description="Total number of times the character has logged in"
    )
    online: bool = Field(default=..., description="If the character is online")


class get_characters_character_id_online(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/online/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_characters_character_id_online]:
        """
        Get character online
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_characters_character_id_online`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_characters_character_id_online`.
        """
        return super().run(
