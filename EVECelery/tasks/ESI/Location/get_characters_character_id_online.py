...
from .Models.get_characters_character_id_online_200 import (
    Response200_get_characters_character_id_online,
)
...
class get_characters_character_id_online(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_online]:
        """
        Get character online
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_online`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_online`.
        """
        return super().run(
