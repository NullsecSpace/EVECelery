...
from .Models.get_characters_character_id_location_200 import (
    Response200_get_characters_character_id_location,
)
...
class get_characters_character_id_location(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_location]:
        """
        Get character location
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_location`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_location`.
        """
        return super().run(
