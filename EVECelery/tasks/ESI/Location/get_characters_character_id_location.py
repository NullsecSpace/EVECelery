...
class SuccessHeaders200_get_characters_character_id_location(ModelTaskBaseResponse):
    """
...
class Success200_get_characters_character_id_location(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_characters_character_id_location = Field(
        ..., description='The response headers for this request.'
    )
    solar_system_id: int = Field(default=..., description="solar_system_id integer")
    station_id: int | None = Field(description="station_id integer")
    structure_id: int | None = Field(description="structure_id integer")


class get_characters_character_id_location(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/location/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_characters_character_id_location]:
        """
        Get character location
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_characters_character_id_location`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_characters_character_id_location`.
        """
        return super().run(
