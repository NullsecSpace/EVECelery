...
from .Models.delete_characters_character_id_fittings_fitting_id_204 import (
    Response204_delete_characters_character_id_fittings_fitting_id,
)


class delete_characters_character_id_fittings_fitting_id(TaskESI):
    """
    Delete fitting
    """
    ...
    def route(self, character_id: int, fitting_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/characters/{character_id}/fittings/{fitting_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_delete_characters_character_id_fittings_fitting_id]:
        """
        Delete fitting
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_delete_characters_character_id_fittings_fitting_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_delete_characters_character_id_fittings_fitting_id`.
        """
        return super().run(
            character_id=character_id,
            fitting_id=fitting_id,
