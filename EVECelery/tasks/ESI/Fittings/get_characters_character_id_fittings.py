...
from .Models.get_characters_character_id_fittings_200 import (
    Response200_get_characters_character_id_fittings,
)


class get_characters_character_id_fittings(TaskESI):
    """
    Get fittings
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/fittings/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_fittings]:
        """
        Get fittings
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_fittings`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_fittings`.
        """
        return super().run(
