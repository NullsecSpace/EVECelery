...
from .Models.get_markets_region_id_history_200 import (
    Response200_get_markets_region_id_history,
)


class get_markets_region_id_history(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_markets_region_id_history]:
        """
        List historical market statistics in a region
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_markets_region_id_history`.
        """
    ...
    @validate_arguments
    def run(
        self, region_id: int, type_id: int, datasource: str = "tranquility", **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_markets_region_id_history`.
        """
        return super().run(
            region_id=region_id, type_id=type_id, datasource=datasource, **kwargs
        )
