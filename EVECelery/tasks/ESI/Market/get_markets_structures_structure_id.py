...
from .Models.get_markets_structures_structure_id_200 import (
    Response200_get_markets_structures_structure_id,
)


class get_markets_structures_structure_id(TaskESI):
    """
    ...
    def route(self, structure_id: int, **kwargs) -> str:
        ...
        """
        return f"/markets/structures/{structure_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_markets_structures_structure_id]:
        """
        List orders in a structure
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_markets_structures_structure_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_markets_structures_structure_id`.
        """
        return super().run(
            structure_id=structure_id,
            datasource=datasource,
