...
from .Models.get_characters_character_id_orders_history_200 import (
    Response200_get_characters_character_id_orders_history,
)


class get_characters_character_id_orders_history(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/orders/history/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_orders_history]:
        """
        List historical orders by a character
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_orders_history`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_orders_history`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
