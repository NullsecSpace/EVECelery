...
from .Models.get_markets_prices_200 import Response200_get_markets_prices


class get_markets_prices(TaskESI):
    """
    List market prices
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_markets_prices]:
        """
        List market prices
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_markets_prices`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_markets_prices`.
        """
