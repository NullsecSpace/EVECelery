...
from .Models.get_characters_character_id_orders_200 import (
    Response200_get_characters_character_id_orders,
)


class get_characters_character_id_orders(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/orders/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_orders]:
        """
        List open orders from a character
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_orders`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_orders`.
        """
        return super().run(
