...
class GetMarketsRegionIdOrdersOkItem(BaseModel):
    duration: int = Field(
        ...,
    ...
    issued: datetime = Field(
        ..., description='issued string', title='get_markets_region_id_orders_issued'
    )
    ...
    price: float = Field(
        ..., description='price number', title='get_markets_region_id_orders_price'
    )
    range: Literal[
        'station',
        'region',
        ...
        ..., description='range string', title='get_markets_region_id_orders_range'
    )
    system_id: int = Field(
        ...,
    ...
    type_id: int = Field(
        ..., description='type_id integer', title='get_markets_region_id_orders_type_id'
    )
...
class GetMarketsRegionIdOrdersOk(BaseModel):
    __root__: List[GetMarketsRegionIdOrdersOkItem] = Field(
        ...,
...
class Headers200_get_markets_region_id_orders(ModelBaseEVECelery):
    """
...
class Response200_get_markets_region_id_orders(ModelCachedResponse):
    """
    A list of orders
    ...
    headers: Headers200_get_markets_region_id_orders = Field(
        ..., description='The response headers for this request.'
    )
    body: GetMarketsRegionIdOrdersOk = Field(
