...
class GetCorporationsCorporationIdOrdersHistoryOkItem(BaseModel):
    duration: int = Field(
        ...,
...
class GetCorporationsCorporationIdOrdersHistoryOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdOrdersHistoryOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_orders_history(ModelBaseEVECelery):
    """
...
class Response200_get_corporations_corporation_id_orders_history(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_corporations_corporation_id_orders_history = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCorporationsCorporationIdOrdersHistoryOk = Field(
