...
class SuccessHeaders200_get_markets_groups_market_group_id(ModelTaskBaseResponse):
    """
...
class Success200_get_markets_groups_market_group_id(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_markets_groups_market_group_id = Field(
        ..., description='The response headers for this request.'
    )
    description: str = Field(default=..., description="description string")
    market_group_id: int = Field(default=..., description="market_group_id integer")
    name: str = Field(default=..., description="name string")
    parent_group_id: int | None = Field(description="parent_group_id integer")
...
class get_markets_groups_market_group_id(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_markets_groups_market_group_id]:
        """
        Get item group information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_markets_groups_market_group_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_markets_groups_market_group_id`.
        """
        return super().run(
            market_group_id=market_group_id,
            datasource=datasource,
