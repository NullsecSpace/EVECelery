...
from .Models.get_corporations_corporation_id_orders_history_200 import (
    Response200_get_corporations_corporation_id_orders_history,
)


class get_corporations_corporation_id_orders_history(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/orders/history/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_orders_history]:
        """
        List historical orders from a corporation
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_orders_history`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_orders_history`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
