...
from .Models.get_corporations_corporation_id_orders_200 import (
    Response200_get_corporations_corporation_id_orders,
)


class get_corporations_corporation_id_orders(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/orders/"
    ...
    def cache_ttl_default(self) -> int:
        ...
        """
        return 1200  # current esi x-cached-seconds header
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_orders]:
        """
        List open orders from a corporation
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_orders`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_orders`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
