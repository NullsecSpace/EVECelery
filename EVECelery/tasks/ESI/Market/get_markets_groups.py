...
class SuccessHeaders200_get_markets_groups(ModelTaskBaseResponse):
    """
...
class Success200_get_markets_groups(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_markets_groups = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of item group ids")


class get_markets_groups(TaskESI):
    """
    Get item groups
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_markets_groups]:
        """
        Get item groups
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_markets_groups`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_markets_groups`.
        """
