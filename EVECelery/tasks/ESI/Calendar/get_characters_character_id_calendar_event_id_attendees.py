...
from .Models.get_characters_character_id_calendar_event_id_attendees_200 import (
    Response200_get_characters_character_id_calendar_event_id_attendees,
)


class get_characters_character_id_calendar_event_id_attendees(TaskESI):
    """
    Get attendees
    """
    ...
    def route(self, character_id: int, event_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/calendar/{event_id}/attendees/"
    ...
    def cache_ttl_default(self) -> int:
        ...
        """
        return 600  # current esi x-cached-seconds header
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_calendar_event_id_attendees]:
        """
        Get attendees
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_calendar_event_id_attendees`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_calendar_event_id_attendees`.
        """
        return super().run(
            character_id=character_id,
            event_id=event_id,
