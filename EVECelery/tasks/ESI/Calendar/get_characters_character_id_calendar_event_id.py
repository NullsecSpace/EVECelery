...
from .Models.get_characters_character_id_calendar_event_id_200 import (
    Response200_get_characters_character_id_calendar_event_id,
)
...
class get_characters_character_id_calendar_event_id(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_calendar_event_id]:
        """
        Get an event
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_calendar_event_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_calendar_event_id`.
        """
        return super().run(
            character_id=character_id,
            event_id=event_id,
