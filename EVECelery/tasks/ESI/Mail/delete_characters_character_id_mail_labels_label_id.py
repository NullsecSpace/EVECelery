...
from .Models.delete_characters_character_id_mail_labels_label_id_204 import (
    Response204_delete_characters_character_id_mail_labels_label_id,
)


class delete_characters_character_id_mail_labels_label_id(TaskESI):
    """
    Delete a mail label
    """
    ...
    def route(self, character_id: int, label_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/characters/{character_id}/mail/labels/{label_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_delete_characters_character_id_mail_labels_label_id]:
        """
        Delete a mail label
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_delete_characters_character_id_mail_labels_label_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_delete_characters_character_id_mail_labels_label_id`.
        """
        return super().run(
            character_id=character_id,
            label_id=label_id,
