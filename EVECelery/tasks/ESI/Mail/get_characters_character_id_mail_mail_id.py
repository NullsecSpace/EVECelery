...
from .Models.get_characters_character_id_mail_mail_id_200 import (
    Response200_get_characters_character_id_mail_mail_id,
)


class get_characters_character_id_mail_mail_id(TaskESI):
    """
    Return a mail
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_mail_mail_id]:
        """
        Return a mail
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_mail_mail_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_mail_mail_id`.
        """
        return super().run(
            character_id=character_id,
            mail_id=mail_id,
