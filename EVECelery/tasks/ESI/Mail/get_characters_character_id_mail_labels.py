...
from .Models.get_characters_character_id_mail_labels_200 import (
    Response200_get_characters_character_id_mail_labels,
)


class get_characters_character_id_mail_labels(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/mail/labels/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_mail_labels]:
        """
        Get mail labels and unread counts
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_mail_labels`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_mail_labels`.
        """
        return super().run(
