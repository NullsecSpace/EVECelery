...
from .Models.get_characters_character_id_mail_lists_200 import (
    Response200_get_characters_character_id_mail_lists,
)


class get_characters_character_id_mail_lists(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/mail/lists/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_mail_lists]:
        """
        Return mailing list subscriptions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_mail_lists`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_mail_lists`.
        """
        return super().run(
