...
from .Models.delete_characters_character_id_mail_mail_id_204 import (
    Response204_delete_characters_character_id_mail_mail_id,
)


class delete_characters_character_id_mail_mail_id(TaskESI):
    """
    Delete a mail
    """
    ...
    def route(self, character_id: int, mail_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/characters/{character_id}/mail/{mail_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response204_delete_characters_character_id_mail_mail_id]:
        """
        Delete a mail
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response204_delete_characters_character_id_mail_mail_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response204_delete_characters_character_id_mail_mail_id`.
        """
        return super().run(
            character_id=character_id,
            mail_id=mail_id,
