...
from .Models.get_characters_character_id_loyalty_points_200 import (
    Response200_get_characters_character_id_loyalty_points,
)


class get_characters_character_id_loyalty_points(TaskESI):
    """
    Get loyalty points
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/loyalty/points/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_loyalty_points]:
        """
        Get loyalty points
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_loyalty_points`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_loyalty_points`.
        """
        return super().run(
