...
from .Models.get_loyalty_stores_corporation_id_offers_200 import (
    Response200_get_loyalty_stores_corporation_id_offers,
)


class get_loyalty_stores_corporation_id_offers(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/loyalty/stores/{corporation_id}/offers/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_loyalty_stores_corporation_id_offers]:
        """
        List loyalty store offers
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_loyalty_stores_corporation_id_offers`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_loyalty_stores_corporation_id_offers`.
        """
        return super().run(
