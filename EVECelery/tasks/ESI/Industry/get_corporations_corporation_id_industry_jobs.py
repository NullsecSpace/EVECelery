...
from .Models.get_corporations_corporation_id_industry_jobs_200 import (
    Response200_get_corporations_corporation_id_industry_jobs,
)


class get_corporations_corporation_id_industry_jobs(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/industry/jobs/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_industry_jobs]:
        """
        List corporation industry jobs
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_industry_jobs`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_industry_jobs`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
