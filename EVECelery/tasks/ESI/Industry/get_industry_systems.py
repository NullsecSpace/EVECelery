...
from .Models.get_industry_systems_200 import Response200_get_industry_systems


class get_industry_systems(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_industry_systems]:
        """
        List solar system cost indices
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_industry_systems`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_industry_systems`.
        """
