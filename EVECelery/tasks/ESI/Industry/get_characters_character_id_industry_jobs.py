...
from .Models.get_characters_character_id_industry_jobs_200 import (
    Response200_get_characters_character_id_industry_jobs,
)


class get_characters_character_id_industry_jobs(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/industry/jobs/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_industry_jobs]:
        """
        List character industry jobs
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_industry_jobs`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_industry_jobs`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
