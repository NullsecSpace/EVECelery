...
from .Models.get_industry_facilities_200 import Response200_get_industry_facilities


class get_industry_facilities(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_industry_facilities]:
        """
        List industry facilities
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_industry_facilities`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_industry_facilities`.
        """
