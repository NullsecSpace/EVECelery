...
from .Models.get_corporation_corporation_id_mining_extractions_200 import (
    Response200_get_corporation_corporation_id_mining_extractions,
)


class get_corporation_corporation_id_mining_extractions(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporation/{corporation_id}/mining/extractions/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporation_corporation_id_mining_extractions]:
        """
        Moon extraction timers
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_extractions`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_extractions`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
