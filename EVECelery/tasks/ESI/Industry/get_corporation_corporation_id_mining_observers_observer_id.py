...
from .Models.get_corporation_corporation_id_mining_observers_observer_id_200 import (
    Response200_get_corporation_corporation_id_mining_observers_observer_id,
)


class get_corporation_corporation_id_mining_observers_observer_id(TaskESI):
    """
    ...
    def route(self, corporation_id: int, observer_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/corporation/{corporation_id}/mining/observers/{observer_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporation_corporation_id_mining_observers_observer_id]:
        """
        Observed corporation mining
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_observers_observer_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_observers_observer_id`.
        """
        return super().run(
            corporation_id=corporation_id,
            observer_id=observer_id,
