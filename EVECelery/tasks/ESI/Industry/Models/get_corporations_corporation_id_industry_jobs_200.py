...
class GetCorporationsCorporationIdIndustryJobsOkItem(BaseModel):
...
class GetCorporationsCorporationIdIndustryJobsOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdIndustryJobsOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_industry_jobs(ModelBaseEVECelery):
    """
...
class Response200_get_corporations_corporation_id_industry_jobs(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_corporations_corporation_id_industry_jobs = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCorporationsCorporationIdIndustryJobsOk = Field(
