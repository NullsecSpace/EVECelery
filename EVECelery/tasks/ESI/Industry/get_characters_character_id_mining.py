...
from .Models.get_characters_character_id_mining_200 import (
    Response200_get_characters_character_id_mining,
)


class get_characters_character_id_mining(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/mining/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_mining]:
        """
        Character mining ledger
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_mining`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_mining`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
