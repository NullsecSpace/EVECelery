...
from .Models.get_corporation_corporation_id_mining_observers_200 import (
    Response200_get_corporation_corporation_id_mining_observers,
)


class get_corporation_corporation_id_mining_observers(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporation/{corporation_id}/mining/observers/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporation_corporation_id_mining_observers]:
        """
        Corporation mining observers
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_observers`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporation_corporation_id_mining_observers`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
