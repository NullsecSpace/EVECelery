...
from .Models.get_characters_character_id_skillqueue_200 import (
    Response200_get_characters_character_id_skillqueue,
)


class get_characters_character_id_skillqueue(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/skillqueue/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_skillqueue]:
        """
        Get character's skill queue
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_skillqueue`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_skillqueue`.
        """
        return super().run(
