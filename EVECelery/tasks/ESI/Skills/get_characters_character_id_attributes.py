...
from .Models.get_characters_character_id_attributes_200 import (
    Response200_get_characters_character_id_attributes,
)
...
class get_characters_character_id_attributes(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_attributes]:
        """
        Get character attributes
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_attributes`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_attributes`.
        """
        return super().run(
