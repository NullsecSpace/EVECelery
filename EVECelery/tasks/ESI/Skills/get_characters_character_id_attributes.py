...
class SuccessHeaders200_get_characters_character_id_attributes(ModelTaskBaseResponse):
    """
...
class Success200_get_characters_character_id_attributes(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_characters_character_id_attributes = Field(
        ..., description='The response headers for this request.'
    )
    accrued_remap_cooldown_date: str | None = Field(
        description="Neural remapping cooldown after a character uses remap accrued over time"
    )
    bonus_remaps: int | None = Field(
        description="Number of available bonus character neural remaps"
    )
    charisma: int = Field(default=..., description="charisma integer")
    intelligence: int = Field(default=..., description="intelligence integer")
    last_remap_date: str | None = Field(
        description="Datetime of last neural remap, including usage of bonus remaps"
    )
    memory: int = Field(default=..., description="memory integer")
    perception: int = Field(default=..., description="perception integer")
    willpower: int = Field(default=..., description="willpower integer")


class get_characters_character_id_attributes(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/attributes/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_characters_character_id_attributes]:
        """
        Get character attributes
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_characters_character_id_attributes`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_characters_character_id_attributes`.
        """
        return super().run(
