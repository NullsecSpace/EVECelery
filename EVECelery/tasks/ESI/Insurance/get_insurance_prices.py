...
from .Models.get_insurance_prices_200 import Response200_get_insurance_prices


class get_insurance_prices(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_insurance_prices]:
        """
        List insurance levels
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_insurance_prices`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_insurance_prices`.
        """
