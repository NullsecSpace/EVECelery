...
from .Models.get_fw_leaderboards_200 import Response200_get_fw_leaderboards


class get_fw_leaderboards(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fw_leaderboards]:
        """
        List of the top factions in faction warfare
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fw_leaderboards`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fw_leaderboards`.
        """
