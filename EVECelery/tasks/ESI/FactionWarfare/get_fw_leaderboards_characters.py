...
from .Models.get_fw_leaderboards_characters_200 import (
    Response200_get_fw_leaderboards_characters,
)


class get_fw_leaderboards_characters(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/fw/leaderboards/characters/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fw_leaderboards_characters]:
        """
        List of the top pilots in faction warfare
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fw_leaderboards_characters`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fw_leaderboards_characters`.
        """
