...
from .Models.get_fw_leaderboards_corporations_200 import (
    Response200_get_fw_leaderboards_corporations,
)


class get_fw_leaderboards_corporations(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/fw/leaderboards/corporations/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fw_leaderboards_corporations]:
        """
        List of the top corporations in faction warfare
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fw_leaderboards_corporations`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fw_leaderboards_corporations`.
        """
