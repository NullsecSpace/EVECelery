...
from .Models.get_fw_stats_200 import Response200_get_fw_stats


class get_fw_stats(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fw_stats]:
        """
        An overview of statistics about factions involved in faction warfare
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fw_stats`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fw_stats`.
        """
