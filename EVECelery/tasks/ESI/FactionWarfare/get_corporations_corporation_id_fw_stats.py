...
from .Models.get_corporations_corporation_id_fw_stats_200 import (
    Response200_get_corporations_corporation_id_fw_stats,
)


class get_corporations_corporation_id_fw_stats(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/fw/stats/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_fw_stats]:
        """
        Overview of a corporation involved in faction warfare
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_fw_stats`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_fw_stats`.
        """
        return super().run(
