...
from .Models.get_fw_systems_200 import Response200_get_fw_systems


class get_fw_systems(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_fw_systems]:
        """
        Ownership of faction warfare systems
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_fw_systems`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_fw_systems`.
        """
