...
class SuccessHeaders200_get_characters_character_id_implants(ModelTaskBaseResponse):
    """
...
class Success200_get_characters_character_id_implants(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_characters_character_id_implants = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of implant type ids")


class get_characters_character_id_implants(TaskESI):
    """
    Get active implants
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/implants/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_characters_character_id_implants]:
        """
        Get active implants
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_characters_character_id_implants`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_characters_character_id_implants`.
        """
        return super().run(
