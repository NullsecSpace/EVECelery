...
from .Models.get_characters_character_id_implants_200 import (
    Response200_get_characters_character_id_implants,
)
...
class get_characters_character_id_implants(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_implants]:
        """
        Get active implants
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_implants`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_implants`.
        """
        return super().run(
