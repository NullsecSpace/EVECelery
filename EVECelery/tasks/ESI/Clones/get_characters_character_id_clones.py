...
from .Models.get_characters_character_id_clones_200 import (
    Response200_get_characters_character_id_clones,
)


class get_characters_character_id_clones(TaskESI):
    """
    Get clones
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/clones/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_clones]:
        """
        Get clones
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_clones`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_clones`.
        """
        return super().run(
