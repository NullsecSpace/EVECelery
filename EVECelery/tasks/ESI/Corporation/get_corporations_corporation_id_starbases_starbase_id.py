...
from .Models.get_corporations_corporation_id_starbases_starbase_id_200 import (
    Response200_get_corporations_corporation_id_starbases_starbase_id,
)


class get_corporations_corporation_id_starbases_starbase_id(TaskESI):
    """
    ...
    def route(self, corporation_id: int, starbase_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/corporations/{corporation_id}/starbases/{starbase_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_starbases_starbase_id]:
        """
        Get starbase (POS) detail
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_starbases_starbase_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_starbases_starbase_id`.
        """
        return super().run(
            corporation_id=corporation_id,
            starbase_id=starbase_id,
