...
from .Models.get_corporations_corporation_id_medals_issued_200 import (
    Response200_get_corporations_corporation_id_medals_issued,
)


class get_corporations_corporation_id_medals_issued(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/medals/issued/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_medals_issued]:
        """
        Get corporation issued medals
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_medals_issued`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_medals_issued`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
