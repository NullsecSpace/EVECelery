...
from .Models.get_corporations_corporation_id_shareholders_200 import (
    Response200_get_corporations_corporation_id_shareholders,
)


class get_corporations_corporation_id_shareholders(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/shareholders/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_shareholders]:
        """
        Get corporation shareholders
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_shareholders`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_shareholders`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
