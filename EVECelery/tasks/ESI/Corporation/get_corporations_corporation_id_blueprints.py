...
from .Models.get_corporations_corporation_id_blueprints_200 import (
    Response200_get_corporations_corporation_id_blueprints,
)


class get_corporations_corporation_id_blueprints(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/blueprints/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_blueprints]:
        """
        Get corporation blueprints
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_blueprints`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_blueprints`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
