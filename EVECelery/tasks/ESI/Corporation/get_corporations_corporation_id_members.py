...
from .Models.get_corporations_corporation_id_members_200 import (
    Response200_get_corporations_corporation_id_members,
)
...
class get_corporations_corporation_id_members(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_members]:
        """
        Get corporation members
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_members`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_members`.
        """
        return super().run(
