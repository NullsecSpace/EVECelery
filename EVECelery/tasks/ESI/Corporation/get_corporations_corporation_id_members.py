...
class SuccessHeaders200_get_corporations_corporation_id_members(ModelTaskBaseResponse):
    """
...
class Success200_get_corporations_corporation_id_members(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_corporations_corporation_id_members = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="List of member character IDs")


class get_corporations_corporation_id_members(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/members/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_corporations_corporation_id_members]:
        """
        Get corporation members
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_corporations_corporation_id_members`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_corporations_corporation_id_members`.
        """
        return super().run(
            corporation_id=corporation_id, datasource=datasource, token=token, **kwargs
        )
