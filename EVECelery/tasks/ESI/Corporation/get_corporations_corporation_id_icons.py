...
class SuccessHeaders200_get_corporations_corporation_id_icons(ModelTaskBaseResponse):
    """
...
class Success200_get_corporations_corporation_id_icons(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_corporations_corporation_id_icons = Field(
...
class get_corporations_corporation_id_icons(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/icons/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_corporations_corporation_id_icons]:
        """
        Get corporation icon
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_corporations_corporation_id_icons`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_corporations_corporation_id_icons`.
        """
        return super().run(
