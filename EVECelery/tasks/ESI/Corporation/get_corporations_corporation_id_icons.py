...
from .Models.get_corporations_corporation_id_icons_200 import (
    Response200_get_corporations_corporation_id_icons,
)
...
class get_corporations_corporation_id_icons(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_icons]:
        """
        Get corporation icon
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_icons`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_icons`.
        """
        return super().run(
