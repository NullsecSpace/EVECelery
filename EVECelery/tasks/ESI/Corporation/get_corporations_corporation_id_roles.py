...
from .Models.get_corporations_corporation_id_roles_200 import (
    Response200_get_corporations_corporation_id_roles,
)


class get_corporations_corporation_id_roles(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/roles/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_roles]:
        """
        Get corporation member roles
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_roles`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_roles`.
        """
        return super().run(
