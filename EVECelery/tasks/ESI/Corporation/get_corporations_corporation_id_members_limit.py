...
from .Models.get_corporations_corporation_id_members_limit_200 import (
    Response200_get_corporations_corporation_id_members_limit,
)


class get_corporations_corporation_id_members_limit(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/members/limit/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_members_limit]:
        """
        Get corporation member limit
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_members_limit`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_members_limit`.
        """
        return super().run(
