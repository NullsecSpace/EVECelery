...
from .Models.get_corporations_corporation_id_divisions_200 import (
    Response200_get_corporations_corporation_id_divisions,
)


class get_corporations_corporation_id_divisions(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/divisions/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_divisions]:
        """
        Get corporation divisions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_divisions`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_divisions`.
        """
        return super().run(
