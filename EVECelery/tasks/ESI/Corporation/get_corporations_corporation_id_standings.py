...
from .Models.get_corporations_corporation_id_standings_200 import (
    Response200_get_corporations_corporation_id_standings,
)


class get_corporations_corporation_id_standings(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/standings/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_standings]:
        """
        Get corporation standings
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_standings`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_standings`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
