...
from .Models.get_corporations_corporation_id_titles_200 import (
    Response200_get_corporations_corporation_id_titles,
)


class get_corporations_corporation_id_titles(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/titles/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_titles]:
        """
        Get corporation titles
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_titles`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_titles`.
        """
        return super().run(
