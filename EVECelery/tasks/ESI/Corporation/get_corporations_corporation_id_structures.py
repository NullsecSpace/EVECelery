...
from .Models.get_corporations_corporation_id_structures_200 import (
    Response200_get_corporations_corporation_id_structures,
)


class get_corporations_corporation_id_structures(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/structures/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_structures]:
        """
        Get corporation structures
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_structures`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_structures`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
