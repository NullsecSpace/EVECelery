...
from .Models.get_corporations_corporation_id_facilities_200 import (
    Response200_get_corporations_corporation_id_facilities,
)


class get_corporations_corporation_id_facilities(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/facilities/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_facilities]:
        """
        Get corporation facilities
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_facilities`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_facilities`.
        """
        return super().run(
