...
from .Models.get_corporations_corporation_id_membertracking_200 import (
    Response200_get_corporations_corporation_id_membertracking,
)


class get_corporations_corporation_id_membertracking(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/membertracking/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_membertracking]:
        """
        Track corporation members
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_membertracking`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_membertracking`.
        """
        return super().run(
