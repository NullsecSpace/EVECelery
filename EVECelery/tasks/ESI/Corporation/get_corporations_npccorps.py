...
from .Models.get_corporations_npccorps_200 import Response200_get_corporations_npccorps
...
class get_corporations_npccorps(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_npccorps]:
        """
        Get npc corporations
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_npccorps`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_npccorps`.
        """
