...
class SuccessHeaders200_get_corporations_npccorps(ModelTaskBaseResponse):
    """
...
class Success200_get_corporations_npccorps(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_corporations_npccorps = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of npc corporation ids")


class get_corporations_npccorps(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/corporations/npccorps/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_corporations_npccorps]:
        """
        Get npc corporations
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_corporations_npccorps`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_corporations_npccorps`.
        """
