...
from .Models.get_corporations_corporation_id_containers_logs_200 import (
    Response200_get_corporations_corporation_id_containers_logs,
)


class get_corporations_corporation_id_containers_logs(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/containers/logs/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_containers_logs]:
        """
        Get all corporation ALSC logs
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_containers_logs`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_containers_logs`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
