...
class Coordinates(BaseModel):
    x: float = Field(
        ..., description='x number', title='get_characters_character_id_bookmarks_x'
    )
    y: float = Field(
        ..., description='y number', title='get_characters_character_id_bookmarks_y'
    )
    z: float = Field(
        ..., description='z number', title='get_characters_character_id_bookmarks_z'
    )
...
class GetCharactersCharacterIdBookmarksOkItem(BaseModel):
...
class GetCharactersCharacterIdBookmarksOk(BaseModel):
    __root__: List[GetCharactersCharacterIdBookmarksOkItem] = Field(
        ...,
...
class Headers200_get_characters_character_id_bookmarks(ModelBaseEVECelery):
    """
...
class Response200_get_characters_character_id_bookmarks(ModelCachedResponse):
    """
    A list of bookmarks
    ...
    headers: Headers200_get_characters_character_id_bookmarks = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCharactersCharacterIdBookmarksOk = Field(
