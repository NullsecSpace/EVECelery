...
from .Models.get_corporations_corporation_id_bookmarks_folders_200 import (
    Response200_get_corporations_corporation_id_bookmarks_folders,
)


class get_corporations_corporation_id_bookmarks_folders(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/bookmarks/folders/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_bookmarks_folders]:
        """
        List corporation bookmark folders
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_bookmarks_folders`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_bookmarks_folders`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
