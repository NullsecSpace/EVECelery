...
from .Models.get_characters_character_id_bookmarks_200 import (
    Response200_get_characters_character_id_bookmarks,
)


class get_characters_character_id_bookmarks(TaskESI):
    """
    List bookmarks
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/bookmarks/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_bookmarks]:
        """
        List bookmarks
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_bookmarks`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_bookmarks`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
