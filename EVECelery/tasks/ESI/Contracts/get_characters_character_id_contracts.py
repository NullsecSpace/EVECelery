...
from .Models.get_characters_character_id_contracts_200 import (
    Response200_get_characters_character_id_contracts,
)


class get_characters_character_id_contracts(TaskESI):
    """
    Get contracts
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/contracts/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_contracts]:
        """
        Get contracts
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_contracts`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_contracts`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
