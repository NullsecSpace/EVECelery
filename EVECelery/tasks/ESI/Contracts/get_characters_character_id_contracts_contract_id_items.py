...
from .Models.get_characters_character_id_contracts_contract_id_items_200 import (
    Response200_get_characters_character_id_contracts_contract_id_items,
)


class get_characters_character_id_contracts_contract_id_items(TaskESI):
    """
    Get contract items
    """
    ...
    def route(self, character_id: int, contract_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/contracts/{contract_id}/items/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_contracts_contract_id_items]:
        """
        Get contract items
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_contracts_contract_id_items`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_contracts_contract_id_items`.
        """
        return super().run(
            character_id=character_id,
            contract_id=contract_id,
