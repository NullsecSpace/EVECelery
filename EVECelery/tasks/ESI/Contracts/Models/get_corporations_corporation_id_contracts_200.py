...
class GetCorporationsCorporationIdContractsOkItem(BaseModel):
...
class GetCorporationsCorporationIdContractsOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdContractsOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_contracts(ModelBaseEVECelery):
    """
...
class Response200_get_corporations_corporation_id_contracts(ModelCachedResponse):
    """
    A list of contracts
    ...
    headers: Headers200_get_corporations_corporation_id_contracts = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCorporationsCorporationIdContractsOk = Field(
