...
class GetCorporationsCorporationIdContractsContractIdItemsOkItem(BaseModel):
...
class GetCorporationsCorporationIdContractsContractIdItemsOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdContractsContractIdItemsOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_contracts_contract_id_items(
    ModelBaseEVECelery
):
    """
...
class Response200_get_corporations_corporation_id_contracts_contract_id_items(
    ModelCachedResponse
):
    """
    ...
    headers: Headers200_get_corporations_corporation_id_contracts_contract_id_items = (
        Field(..., description='The response headers for this request.')
    )
    body: GetCorporationsCorporationIdContractsContractIdItemsOk = Field(
