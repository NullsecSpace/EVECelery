...
class GetContractsPublicBidsContractIdOkItem(BaseModel):
    amount: float = Field(
        ...,
...
class GetContractsPublicBidsContractIdOk(BaseModel):
    __root__: List[GetContractsPublicBidsContractIdOkItem] = Field(
        ...,
...
class Headers200_get_contracts_public_bids_contract_id(ModelBaseEVECelery):
    """
...
class Response200_get_contracts_public_bids_contract_id(ModelCachedResponse):
    """
    A list of bids
    ...
    headers: Headers200_get_contracts_public_bids_contract_id = Field(
        ..., description='The response headers for this request.'
    )
    body: GetContractsPublicBidsContractIdOk = Field(
