...
class GetCharactersCharacterIdContractsContractIdBidsOkItem(BaseModel):
    amount: float = Field(
        ...,
...
class GetCharactersCharacterIdContractsContractIdBidsOk(BaseModel):
    __root__: List[GetCharactersCharacterIdContractsContractIdBidsOkItem] = Field(
        ...,
...
class Headers200_get_characters_character_id_contracts_contract_id_bids(
    ModelBaseEVECelery
):
    """
...
class Response200_get_characters_character_id_contracts_contract_id_bids(
    ModelCachedResponse
):
    """
    A list of bids
    ...
    headers: Headers200_get_characters_character_id_contracts_contract_id_bids = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCharactersCharacterIdContractsContractIdBidsOk = Field(
