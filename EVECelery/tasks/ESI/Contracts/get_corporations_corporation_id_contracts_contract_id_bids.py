...
from .Models.get_corporations_corporation_id_contracts_contract_id_bids_200 import (
    Response200_get_corporations_corporation_id_contracts_contract_id_bids,
)


class get_corporations_corporation_id_contracts_contract_id_bids(TaskESI):
    """
    ...
    def route(self, contract_id: int, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/contracts/{contract_id}/bids/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_contracts_contract_id_bids]:
        """
        Get corporation contract bids
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_contracts_contract_id_bids`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_contracts_contract_id_bids`.
        """
        return super().run(
            contract_id=contract_id,
            corporation_id=corporation_id,
