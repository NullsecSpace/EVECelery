...
from .Models.get_contracts_public_bids_contract_id_200 import (
    Response200_get_contracts_public_bids_contract_id,
)

from .Models.get_contracts_public_bids_contract_id_204 import (
    Response204_get_contracts_public_bids_contract_id,
)


class get_contracts_public_bids_contract_id(TaskESI):
    """
    ...
    def route(self, contract_id: int, **kwargs) -> str:
        ...
        """
        return f"/contracts/public/bids/{contract_id}/"
    ...
    def get_sync(
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_contracts_public_bids_contract_id` or :class:`Response204_get_contracts_public_bids_contract_id`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_contracts_public_bids_contract_id` or :class:`Response204_get_contracts_public_bids_contract_id`.
        """
        return super().run(
