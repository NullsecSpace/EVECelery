...
from .Models.get_status_200 import Response200_get_status
...
class get_status(TaskESI):
    ...
    def get_sync(
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_status`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_status`.
        """
