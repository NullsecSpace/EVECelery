...
from .Models.get_sovereignty_campaigns_200 import Response200_get_sovereignty_campaigns


class get_sovereignty_campaigns(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/sovereignty/campaigns/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_sovereignty_campaigns]:
        """
        List sovereignty campaigns
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_sovereignty_campaigns`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_sovereignty_campaigns`.
        """
