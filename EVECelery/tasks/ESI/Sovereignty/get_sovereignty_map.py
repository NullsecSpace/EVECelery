...
from .Models.get_sovereignty_map_200 import Response200_get_sovereignty_map


class get_sovereignty_map(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_sovereignty_map]:
        """
        List sovereignty of systems
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_sovereignty_map`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_sovereignty_map`.
        """
