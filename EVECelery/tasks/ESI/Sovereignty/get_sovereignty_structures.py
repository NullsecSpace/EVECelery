...
from .Models.get_sovereignty_structures_200 import (
    Response200_get_sovereignty_structures,
)


class get_sovereignty_structures(TaskESI):
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/sovereignty/structures/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_sovereignty_structures]:
        """
        List sovereignty structures
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_sovereignty_structures`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_sovereignty_structures`.
        """
