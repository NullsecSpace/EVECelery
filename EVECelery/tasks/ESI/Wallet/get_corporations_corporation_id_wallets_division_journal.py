...
from .Models.get_corporations_corporation_id_wallets_division_journal_200 import (
    Response200_get_corporations_corporation_id_wallets_division_journal,
)


class get_corporations_corporation_id_wallets_division_journal(TaskESI):
    """
    ...
    def route(self, corporation_id: int, division: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/wallets/{division}/journal/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_wallets_division_journal]:
        """
        Get corporation wallet journal
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_wallets_division_journal`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_wallets_division_journal`.
        """
        return super().run(
            corporation_id=corporation_id,
            division=division,
