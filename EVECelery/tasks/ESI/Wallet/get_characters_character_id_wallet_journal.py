...
from .Models.get_characters_character_id_wallet_journal_200 import (
    Response200_get_characters_character_id_wallet_journal,
)


class get_characters_character_id_wallet_journal(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/wallet/journal/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_wallet_journal]:
        """
        Get character wallet journal
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_wallet_journal`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_wallet_journal`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
