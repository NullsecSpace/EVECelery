...
from .Models.get_characters_character_id_wallet_transactions_200 import (
    Response200_get_characters_character_id_wallet_transactions,
)


class get_characters_character_id_wallet_transactions(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/wallet/transactions/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_wallet_transactions]:
        """
        Get wallet transactions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_wallet_transactions`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_wallet_transactions`.
        """
        return super().run(
            character_id=character_id,
            datasource=datasource,
