...
class GetCorporationsCorporationIdWalletsDivisionJournalOkItem(BaseModel):
    ...
    context_id: Optional[int] = Field(
        ...
        title='get_corporations_corporation_id_wallets_division_journal_context_id',
    )
    context_id_type: Optional[
        ...
        title='get_corporations_corporation_id_wallets_division_journal_context_id_type',
    )
    date: datetime = Field(
        ...,
    ...
    description: str = Field(
        ...
        title='get_corporations_corporation_id_wallets_division_journal_description',
    )
    ...
    id: int = Field(
        ...
        title='get_corporations_corporation_id_wallets_division_journal_id',
    )
...
class GetCorporationsCorporationIdWalletsDivisionJournalOk(BaseModel):
    __root__: List[GetCorporationsCorporationIdWalletsDivisionJournalOkItem] = Field(
        ...,
...
class Headers200_get_corporations_corporation_id_wallets_division_journal(
    ModelBaseEVECelery
):
    """
...
class Response200_get_corporations_corporation_id_wallets_division_journal(
    ModelCachedResponse
):
    """
    Journal entries
    ...
    headers: Headers200_get_corporations_corporation_id_wallets_division_journal = (
        Field(..., description='The response headers for this request.')
    )
    body: GetCorporationsCorporationIdWalletsDivisionJournalOk = Field(
