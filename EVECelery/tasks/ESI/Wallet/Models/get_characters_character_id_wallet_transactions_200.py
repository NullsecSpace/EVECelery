...
class GetCharactersCharacterIdWalletTransactionsOkItem(BaseModel):
    client_id: int = Field(
        ...,
...
class GetCharactersCharacterIdWalletTransactionsOk(BaseModel):
    __root__: List[GetCharactersCharacterIdWalletTransactionsOkItem] = Field(
        ...,
...
class Headers200_get_characters_character_id_wallet_transactions(ModelBaseEVECelery):
    """
...
class Response200_get_characters_character_id_wallet_transactions(ModelCachedResponse):
    """
    Wallet transactions
    ...
    headers: Headers200_get_characters_character_id_wallet_transactions = Field(
        ..., description='The response headers for this request.'
    )
    body: GetCharactersCharacterIdWalletTransactionsOk = Field(
