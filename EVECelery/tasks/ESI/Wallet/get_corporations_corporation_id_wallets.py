...
from .Models.get_corporations_corporation_id_wallets_200 import (
    Response200_get_corporations_corporation_id_wallets,
)


class get_corporations_corporation_id_wallets(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/wallets/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_wallets]:
        """
        Returns a corporation's wallet balance
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_wallets`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_wallets`.
        """
        return super().run(
