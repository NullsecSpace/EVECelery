...
from .Models.get_characters_character_id_wallet_200 import (
    Response200_get_characters_character_id_wallet,
)


class get_characters_character_id_wallet(TaskESI):
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/wallet/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_wallet]:
        """
        Get a character's wallet balance
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_wallet`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_wallet`.
        """
        return super().run(
