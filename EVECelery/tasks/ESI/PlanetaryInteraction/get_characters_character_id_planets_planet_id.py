...
from .Models.get_characters_character_id_planets_planet_id_200 import (
    Response200_get_characters_character_id_planets_planet_id,
)


class get_characters_character_id_planets_planet_id(TaskESI):
    """
    Get colony layout
    """
    ...
    def route(self, character_id: int, planet_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/characters/{character_id}/planets/{planet_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_planets_planet_id]:
        """
        Get colony layout
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_planets_planet_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_planets_planet_id`.
        """
        return super().run(
            character_id=character_id,
            planet_id=planet_id,
