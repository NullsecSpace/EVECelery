...
from .Models.get_corporations_corporation_id_customs_offices_200 import (
    Response200_get_corporations_corporation_id_customs_offices,
)


class get_corporations_corporation_id_customs_offices(TaskESI):
    """
    ...
    def route(self, corporation_id: int, **kwargs) -> str:
        ...
        """
        return f"/corporations/{corporation_id}/customs_offices/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_corporations_corporation_id_customs_offices]:
        """
        List corporation customs offices
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_corporations_corporation_id_customs_offices`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_corporations_corporation_id_customs_offices`.
        """
        return super().run(
            corporation_id=corporation_id,
            datasource=datasource,
