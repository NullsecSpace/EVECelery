...
from .Models.get_characters_character_id_planets_200 import (
    Response200_get_characters_character_id_planets,
)


class get_characters_character_id_planets(TaskESI):
    """
    Get colonies
    """
    ...
    def route(self, character_id: int, **kwargs) -> str:
        ...
        """
        return f"/characters/{character_id}/planets/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_characters_character_id_planets]:
        """
        Get colonies
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_characters_character_id_planets`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_characters_character_id_planets`.
        """
        return super().run(
