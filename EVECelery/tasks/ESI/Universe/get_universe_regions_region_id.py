...
class SuccessHeaders200_get_universe_regions_region_id(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_regions_region_id(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_regions_region_id = Field(
        ..., description='The response headers for this request.'
    )
    constellations: list[int] = Field(default=..., description="constellations array")
    description: str | None = Field(description="description string")
    name: str = Field(default=..., description="name string")
    region_id: int = Field(default=..., description="region_id integer")


class get_universe_regions_region_id(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_regions_region_id]:
        """
        Get region information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_regions_region_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_regions_region_id`.
        """
        return super().run(
            region_id=region_id, datasource=datasource, language=language, **kwargs
        )
