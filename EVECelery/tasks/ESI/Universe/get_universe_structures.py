...
from .Models.get_universe_structures_200 import Response200_get_universe_structures
...
class get_universe_structures(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_structures]:
        """
        List all public structures
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_structures`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_structures`.
        """
