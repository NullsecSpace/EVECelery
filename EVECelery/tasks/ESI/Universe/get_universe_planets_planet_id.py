...
from .Models.get_universe_planets_planet_id_200 import (
    Response200_get_universe_planets_planet_id,
)


class get_universe_planets_planet_id(TaskESI):
    """
    ...
    def route(self, planet_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/universe/planets/{planet_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_planets_planet_id]:
        """
        Get planet information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_planets_planet_id`.
        """
    ...
    @validate_arguments
    def run(self, planet_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_planets_planet_id`.
        """
        return super().run(planet_id=planet_id, datasource=datasource, **kwargs)
