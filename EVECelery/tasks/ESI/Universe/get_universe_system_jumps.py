...
from .Models.get_universe_system_jumps_200 import Response200_get_universe_system_jumps


class get_universe_system_jumps(TaskESI):
    """
    Get system jumps
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/universe/system_jumps/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_system_jumps]:
        """
        Get system jumps
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_system_jumps`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_system_jumps`.
        """
