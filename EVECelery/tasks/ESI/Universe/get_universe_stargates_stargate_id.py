...
from .Models.get_universe_stargates_stargate_id_200 import (
    Response200_get_universe_stargates_stargate_id,
)


class get_universe_stargates_stargate_id(TaskESI):
    """
    ...
    def route(self, stargate_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/universe/stargates/{stargate_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_stargates_stargate_id]:
        """
        Get stargate information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_stargates_stargate_id`.
        """
    ...
    @validate_arguments
    def run(self, stargate_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_stargates_stargate_id`.
        """
        return super().run(stargate_id=stargate_id, datasource=datasource, **kwargs)
