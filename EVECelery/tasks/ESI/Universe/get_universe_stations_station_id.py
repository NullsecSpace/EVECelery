...
from .Models.get_universe_stations_station_id_200 import (
    Response200_get_universe_stations_station_id,
)


class get_universe_stations_station_id(TaskESI):
    """
    ...
    def route(self, station_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/universe/stations/{station_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_stations_station_id]:
        """
        Get station information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_stations_station_id`.
        """
    ...
    @validate_arguments
    def run(self, station_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_stations_station_id`.
        """
        return super().run(station_id=station_id, datasource=datasource, **kwargs)
