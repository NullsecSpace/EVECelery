...
class SuccessHeaders200_get_universe_constellations(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_constellations(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_constellations = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of constellation ids")


class get_universe_constellations(TaskESI):
    """
    Get constellations
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/universe/constellations/"
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_constellations]:
        """
        Get constellations
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_constellations`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_constellations`.
        """
