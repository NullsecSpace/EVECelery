...
class SuccessHeaders200_get_universe_graphics(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_graphics(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_graphics = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of graphic ids")


class get_universe_graphics(TaskESI):
    """
    Get graphics
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_graphics]:
        """
        Get graphics
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_graphics`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_graphics`.
        """
