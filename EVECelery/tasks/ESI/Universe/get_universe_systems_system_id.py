...
from .Models.get_universe_systems_system_id_200 import (
    Response200_get_universe_systems_system_id,
)


class get_universe_systems_system_id(TaskESI):
    """
    ...
    def route(self, system_id: int, **kwargs) -> str:
        """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_systems_system_id]:
        """
        Get solar system information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_systems_system_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_systems_system_id`.
        """
        return super().run(
            system_id=system_id, datasource=datasource, language=language, **kwargs
        )
