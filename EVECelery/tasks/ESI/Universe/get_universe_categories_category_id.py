...
from .Models.get_universe_categories_category_id_200 import (
    Response200_get_universe_categories_category_id,
)
...
class get_universe_categories_category_id(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_categories_category_id]:
        """
        Get item category information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_categories_category_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_categories_category_id`.
        """
        return super().run(
