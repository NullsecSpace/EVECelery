...
from .Models.get_universe_types_type_id_200 import (
    Response200_get_universe_types_type_id,
)


class get_universe_types_type_id(TaskESI):
    """
    ...
    def route(self, type_id: int, **kwargs) -> str:
        """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_types_type_id]:
        """
        Get type information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_types_type_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_types_type_id`.
        """
        return super().run(
            type_id=type_id, datasource=datasource, language=language, **kwargs
        )
