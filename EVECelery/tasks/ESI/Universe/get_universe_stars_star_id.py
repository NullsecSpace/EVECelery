...
from .Models.get_universe_stars_star_id_200 import (
    Response200_get_universe_stars_star_id,
)
...
class get_universe_stars_star_id(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_stars_star_id]:
        """
        Get star information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_stars_star_id`.
        """
    ...
    def run(self, star_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_stars_star_id`.
        """
