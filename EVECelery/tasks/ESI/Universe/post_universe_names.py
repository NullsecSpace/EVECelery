...
from .Models.post_universe_names_200 import Response200_post_universe_names


class post_universe_names(TaskESI):
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_post_universe_names]:
        """
        Get names and categories for a set of IDs
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_post_universe_names`.
        """
    ...
    @validate_arguments
    def run(self, ids: list[int], datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_post_universe_names`.
        """
        return super().run(ids=ids, datasource=datasource, **kwargs)
