...
from .Models.get_universe_moons_moon_id_200 import (
    Response200_get_universe_moons_moon_id,
)


class get_universe_moons_moon_id(TaskESI):
    """
    ...
    def route(self, moon_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/universe/moons/{moon_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_moons_moon_id]:
        """
        Get moon information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_moons_moon_id`.
        """
    ...
    @validate_arguments
    def run(self, moon_id: int, datasource: str = "tranquility", **kwargs) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_moons_moon_id`.
        """
        return super().run(moon_id=moon_id, datasource=datasource, **kwargs)
