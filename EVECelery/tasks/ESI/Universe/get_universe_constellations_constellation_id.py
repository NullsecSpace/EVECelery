...
from .Models.get_universe_constellations_constellation_id_200 import (
    Response200_get_universe_constellations_constellation_id,
)


class get_universe_constellations_constellation_id(TaskESI):
    """
    ...
    def route(self, constellation_id: int, **kwargs) -> str:
        """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_constellations_constellation_id]:
        """
        Get constellation information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_constellations_constellation_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_constellations_constellation_id`.
        """
        return super().run(
            constellation_id=constellation_id,
            datasource=datasource,
