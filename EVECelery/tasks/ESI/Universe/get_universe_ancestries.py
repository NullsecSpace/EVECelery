...
from .Models.get_universe_ancestries_200 import Response200_get_universe_ancestries


class get_universe_ancestries(TaskESI):
    """
    Get ancestries
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_ancestries]:
        """
        Get ancestries
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_ancestries`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_ancestries`.
        """
