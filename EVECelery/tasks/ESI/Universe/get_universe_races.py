...
from .Models.get_universe_races_200 import Response200_get_universe_races


class get_universe_races(TaskESI):
    """
    Get character races
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_races]:
        """
        Get character races
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_races`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_races`.
        """
