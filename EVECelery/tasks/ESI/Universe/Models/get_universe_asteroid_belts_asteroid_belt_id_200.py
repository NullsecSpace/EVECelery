...
class GetUniverseAsteroidBeltsAsteroidBeltIdOk(BaseModel):
    name: str = Field(
        ...,
...
class Headers200_get_universe_asteroid_belts_asteroid_belt_id(ModelBaseEVECelery):
    """
...
class Response200_get_universe_asteroid_belts_asteroid_belt_id(ModelCachedResponse):
    """
    ...
    headers: Headers200_get_universe_asteroid_belts_asteroid_belt_id = Field(
        ..., description='The response headers for this request.'
    )
    body: GetUniverseAsteroidBeltsAsteroidBeltIdOk = Field(
