...
class SuccessHeaders200_get_universe_systems(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_systems(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_systems = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of solar system ids")


class get_universe_systems(TaskESI):
    """
    Get solar systems
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_systems]:
        """
        Get solar systems
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_systems`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_systems`.
        """
