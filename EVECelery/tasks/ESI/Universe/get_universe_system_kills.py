...
from .Models.get_universe_system_kills_200 import Response200_get_universe_system_kills


class get_universe_system_kills(TaskESI):
    """
    Get system kills
    """
    ...
    def route(self, **kwargs) -> str:
        ...
        """
        return f"/universe/system_kills/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_system_kills]:
        """
        Get system kills
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_system_kills`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_system_kills`.
        """
