...
from .Models.get_universe_regions_200 import Response200_get_universe_regions
...
class get_universe_regions(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_regions]:
        """
        Get regions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_regions`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_regions`.
        """
