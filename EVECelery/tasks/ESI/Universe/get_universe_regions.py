...
class SuccessHeaders200_get_universe_regions(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_regions(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_regions = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of region ids")


class get_universe_regions(TaskESI):
    """
    Get regions
    """
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_regions]:
        """
        Get regions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_regions`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_regions`.
        """
