...
from .Models.get_universe_groups_group_id_200 import (
    Response200_get_universe_groups_group_id,
)
...
class get_universe_groups_group_id(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_groups_group_id]:
        """
        Get item group information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_groups_group_id`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_groups_group_id`.
        """
        return super().run(
