...
from .Models.get_universe_bloodlines_200 import Response200_get_universe_bloodlines


class get_universe_bloodlines(TaskESI):
    """
    Get bloodlines
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_bloodlines]:
        """
        Get bloodlines
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_bloodlines`.
        """
    ...
    @validate_arguments
    def run(
        self, datasource: str = "tranquility", language: str = "en", **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_bloodlines`.
        """
        return super().run(datasource=datasource, language=language, **kwargs)
