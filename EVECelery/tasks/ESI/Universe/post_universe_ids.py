...
from .Models.post_universe_ids_200 import Response200_post_universe_ids


class post_universe_ids(TaskESI):
    """
    Bulk names to IDs
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_post_universe_ids]:
        """
        Bulk names to IDs
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_post_universe_ids`.
        """
    ...
    def run(
        ...
        **kwargs,
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_post_universe_ids`.
        """
        return super().run(
            names=names, datasource=datasource, language=language, **kwargs
        )
