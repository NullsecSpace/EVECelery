...
class SuccessHeaders200_get_universe_categories(ModelTaskBaseResponse):
    """
...
class Success200_get_universe_categories(ModelCachedSuccess):
    """
    ...
    headers: SuccessHeaders200_get_universe_categories = Field(
        ..., description='The response headers for this request.'
    )
    items: list[int] | None = Field(description="A list of item category ids")
...
class get_universe_categories(TaskESI):
    ...
    def get_sync(
    ...
    ) -> Union[Success200_get_universe_categories]:
        """
        Get item categories
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Success200_get_universe_categories`.
        """
    ...
    def run(self, datasource: str = "tranquility", **kwargs) -> dict:
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Success200_get_universe_categories`.
        """
