...
from .Models.get_universe_asteroid_belts_asteroid_belt_id_200 import (
    Response200_get_universe_asteroid_belts_asteroid_belt_id,
)


class get_universe_asteroid_belts_asteroid_belt_id(TaskESI):
    """
    ...
    def route(self, asteroid_belt_id: int, **kwargs) -> str:
        """
        ...
        """
        return f"/universe/asteroid_belts/{asteroid_belt_id}/"
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_asteroid_belts_asteroid_belt_id]:
        """
        Get asteroid belt information
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_asteroid_belts_asteroid_belt_id`.
        """
    ...
    @validate_arguments
    def run(
        self, asteroid_belt_id: int, datasource: str = "tranquility", **kwargs
    ) -> dict:
        """
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_asteroid_belts_asteroid_belt_id`.
        """
        return super().run(
            asteroid_belt_id=asteroid_belt_id, datasource=datasource, **kwargs
        )
