...
from .Models.get_universe_factions_200 import Response200_get_universe_factions


class get_universe_factions(TaskESI):
    """
    Get factions
    """
    ...
    def get_sync(
    ...
    ) -> Union[Response200_get_universe_factions]:
        """
        Get factions
        ...
        :return: The response from ESI as a pydantic object. The response model will follow the structure of :class:`Response200_get_universe_factions`.
        """
    ...
    def run(
        ...
        :return: The response from ESI as a JSON dictionary. The response dictionary will follow the structure of :class:`Response200_get_universe_factions`.
        """
